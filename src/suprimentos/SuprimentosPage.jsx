...
import { SUP_CATEGORIAS, SUP_EXEC_COBERTURA_ALVO, SUP_FARMACOS_MONITORADOS, SUP_INV_INTERVALO, SUP_PED_STATUS, SUP_REQ_STATUS } from "./catalogo.js";
import { comprarParaConsumo, consumoParaCompra, custoPorUnidadeCompra, custoPorUnidadeConsumo, rotuloCompra } from "./conversao.js";
import { addSupCotacaoRemote, addSupInventarioRemote, addSupMovimentoRemote, addSupPedidoRemote, addSupRequisicaoRemote, atualizarSupCotacaoRemote, atualizarSupPedidoRemote, atualizarSupReqRemote, deleteSupFornecedorRemote, deleteSupItemRemote, loadSupCotacoes, loadSupEntradasComForn, loadSupFornecedores, loadSupInventarios, loadSupItens, loadSupLotes, loadSupMovimentosPeriodo, loadSupPedidos, loadSupRequisicoes, loadSupSaidasDesde, setSupItemCustoRemote, upsertSupFornecedorRemote, upsertSupItemRemote } from "./dados.js";
import { MOTIVO_AJUSTE, descreverPlano, documentoDaContagem, movimentoDeEstorno, podeEstornar } from "./inventario.js";
...
import { SupContagemModal, SupCotacaoModal, SupFornecedorModal, SupItemModal, SupKardexModal, SupMovModal, SupNfeModal, SupNovaCotacaoModal, SupNovaReqModal, SupNovoPedidoModal, SupRecebModal } from "./modais.jsx";
